...
const Sidebar = () => {
  ...
  return (
    <div className={`sidebar-wrapper dark:bg-neutral-900 bg-white py-5 px-4 dark:shadow-[0_0.125rem_0.25rem_rgba(180,180,180,0.3)] shadow-[0_0.125rem_0.25rem_rgba(165,163,174,0.3)] lg:w-[20%] md:w-[30%] w-[40%] h-full flex flex-col rounded-sm z-[999] fixed lg:left-0 ${isSidebarOpen ? 'left-0':'left-[100%]'}`}>
      <div className='sidebar-top mb-[32px] flex items-center justify-between'>
        ...
        <button className='sidebar-close text-black p-[0.125rem] rounded-sm bg-neutral-500 cursor-pointer hover:bg-neutral-200 lg:hidden'
