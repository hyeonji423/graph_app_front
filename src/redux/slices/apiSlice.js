...
import { GET_VISITORS_API_URL, GET_REVENUE_API_URL, GET_CUSTOMERS_API_URL, GET_TARGET_REALITY_API_URL, GET_TOP_PRODECTS_API_URL, GET_SALES_MAP_API_URL, GET_VOLUME_SERVICES_API_URL } from '../../constants/apiUrl'
...
const apiSlice = createSlice({
  ...
  extraReducers: (builder)=>{
    builder
      ...
      .addCase(fetchTargetReality.fulfilled, handleFulfilled('tragetRealityData'))
